...
const LandingHeader = () => {
    ...
    const shouldUseHeroBackground = scrollY <= 50 && !isMenuOpen;

    return (
        <header
            className={`fixed w-full z-50 transition-all duration-500 ${!shouldUseHeroBackground
                ...
                <div className="flex justify-between items-center py-3">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            <h1
                                className={`text-2xl font-bold transition-colors duration-300 ${!shouldUseHeroBackground
                                    ? "text-gray-900"
                                    : "text-gray-800"
                                    }`}
                            >
                            ...
                            <p
                                className={`text-md transition-colors duration-300 ${!shouldUseHeroBackground
                                    ? "text-gray-600"
                                    : "text-gray-700"
                                    }`}
                            >
                        ...
                        {[
                            ...
                            return (
                                <Link
                                    ...
                                    to={item.path}
                                    onClick={handleLinkClick}
                                    className={`text-md font-medium transition-all duration-300 hover:scale-105 relative group ${!shouldUseHeroBackground
                    ...
                    <button
                        ...
                        className={`md:hidden p-2 rounded-lg transition-all duration-300 hover:scale-110 ${!shouldUseHeroBackground
